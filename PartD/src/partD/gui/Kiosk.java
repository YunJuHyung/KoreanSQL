...
//Kiosk.java 클래스를 kioskTest.java 로 복사하세요.
//				ㄴ 메뉴 항목 6개가 만들어질 때 반복되는 코드를 반복문으로 변경해보세요.
//				ㄴ btStringX 문자열 변수도 배열로 변경, 메뉴 항목 6개의 컴포넌트도 배열로 변경해서 합니다.
//				ㄴ 그 외의 코딩하면서 배열로 바뀌는게 필요하다 판단되면 변경해서 해보세요.
public class Kiosk {
...
///////// 메뉴 패널 컴포넌트들
		...
		lblpc1.setBounds(52, 151, 108, 29);				//(52, 58, 147, 95);	//레이블 위치 (52, 151, 108, 29);  x=그림, y=그림+93
